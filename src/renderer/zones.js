...
import {
  HEIGHT_DISPATCH, HEIGHT_BRAIN, HEIGHT_DEFAULT, HEIGHT_RUIN,
} from './constants.js';
...
export const ZONE_DEFS = [
  // ── Ring 0 (Center) ──────────────────────────────────────────────
  {
    id: 'dispatch', name: 'Dispatch Tower',
    tileX: 20, tileY: 20, w: 4, h: 4,
    ring: 0, district: 'core', height: HEIGHT_DISPATCH, active: true,
  },
  {
    id: 'brain', name: 'Brain Library',
    tileX: 16, tileY: 20, w: 3, h: 3,
    ring: 0, district: 'core', height: HEIGHT_BRAIN, active: true,
  },

  // ── Ring 1 (Core Ops) ────────────────────────────────────────────
  {
    id: 'chat', name: 'Chat Rooms',
    tileX: 14, tileY: 16, w: 3, h: 3,
    ring: 1, district: 'core', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'memory', name: 'Memory Vault',
    tileX: 24, tileY: 16, w: 3, h: 3,
    ring: 1, district: 'core', height: HEIGHT_DEFAULT, active: true,
  },
  {
    id: 'skills', name: 'Skills Academy',
    tileX: 14, tileY: 24, w: 3, h: 3,
    ring: 1, district: 'core', height: HEIGHT_DEFAULT, active: true,
  },
  {
    id: 'minions', name: 'Minion Tunnels',
    tileX: 24, tileY: 24, w: 3, h: 3,
    ring: 1, district: 'core', height: HEIGHT_DEFAULT, active: false,
  },
  ...
  // ── Ring 2 (Business) ────────────────────────────────────────────
  {
    ...
    tileX: 28, tileY: 20, w: 3, h: 3,
    ring: 2, district: 'business', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'sales', name: 'Sales District',
    tileX: 28, tileY: 26, w: 3, h: 3,
    ring: 2, district: 'business', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'marketing', name: 'Marketing Plaza',
    tileX: 22, tileY: 30, w: 3, h: 3,
    ring: 2, district: 'business', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'exchange', name: 'The Exchange',
    tileX: 32, tileY: 18, w: 3, h: 3,
    ring: 2, district: 'business', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'market', name: 'The Market',
    tileX: 32, tileY: 24, w: 3, h: 3,
    ring: 2, district: 'business', height: HEIGHT_DEFAULT, active: false,
  },
  ...
  // ── Ring 3 (Advanced) ────────────────────────────────────────────
  {
    ...
    tileX: 10, tileY: 14, w: 3, h: 3,
    ring: 3, district: 'advanced', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'rnd', name: 'R&D Lab',
    tileX: 10, tileY: 20, w: 3, h: 3,
    ring: 3, district: 'advanced', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'legal', name: 'Legal Tower',
    tileX: 16, tileY: 12, w: 3, h: 3,
    ring: 3, district: 'advanced', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'archive', name: 'The Archive',
    tileX: 10, tileY: 26, w: 3, h: 3,
    ring: 3, district: 'advanced', height: HEIGHT_DEFAULT, active: false,
  },

  // ── Edges ────────────────────────────────────────────────────────
  {
    id: 'docks', name: 'Connector Docks',
    tileX: 8, tileY: 30, w: 4, h: 3,
    ring: 4, district: 'edge', height: HEIGHT_DEFAULT, active: true,
  },
  {
    id: 'airport', name: 'Airport',
    tileX: 34, tileY: 10, w: 4, h: 4,
    ring: 4, district: 'edge', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'globe', name: 'Globe Room',
    tileX: 28, tileY: 10, w: 3, h: 3,
    ring: 4, district: 'edge', height: HEIGHT_DEFAULT, active: false,
  },
  {
    id: 'broadcast', name: 'Broadcast Tower',
    tileX: 20, tileY: 8, w: 3, h: 3,
    ring: 4, district: 'edge', height: HEIGHT_DEFAULT, active: false,
  },
];
