...
export class NotificationCenter {
  ...
  push(notification) {
    const entry = {
      ...
      icon:      notification.icon || CATEGORY_ICONS[notification.category] || CATEGORY_ICONS.system,
  ...
  _injectCSS() {
    ...
    this._styleEl.href = new URL('./notification-center.css', import.meta.url).href;
  ...
  _renderItem(n) {
    ...
    // Icon
    const iconEl = el('div', 'nc-item__icon', n.icon || CATEGORY_ICONS[n.category] || CATEGORY_ICONS.system);
