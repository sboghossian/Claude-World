...
export const SHORTCUTS_REGISTRY = [
  // Navigation
  {
    key: "h",
    meta: false,
    label: "Camera go home",
    display: "H",
    action: "shortcut:camera-home",
    category: "navigation",
  },
  {
    key: "Tab",
    meta: false,
    label: "Cycle zones forward",
    display: "Tab",
    action: "shortcut:cycle-zones",
    category: "navigation",
  },
  {
    key: "Tab",
  ...
  },
  {
    key: " ",
    meta: false,
    label: "Pause / Resume day cycle",
    display: "Space",
    action: "shortcut:toggle-day-cycle",
    category: "navigation",
  },
  // Zone quick-jump 1-9
  {
    key: "1",
    meta: false,
    label: "Jump to Dispatch Tower",
    display: "1",
    action: "shortcut:jump-zone",
    detail: { index: 0 },
    category: "navigation",
  },
  {
  ...
  // Zones (Cmd shortcuts)
  {
    key: "d",
    meta: true,
    label: "Dispatch Tower",
    display: "\u2318D",
    action: "shortcut:zone-dispatch",
    category: "zones",
  },
  {
    key: "b",
  ...
  // UI
  {
    ...
    display: "\u2318K",
    action: "shortcut:toggle-palette",
    category: "ui",
  },
  {
    key: ",",
  ...
  },
  {
    ...
    display: "\u2318\u21E7B",
    action: "shortcut:morning-briefing",
    category: "world",
  },
  {
    key: "t",
  ...
  _handleKeyDown(e) {
    ...
    if (metaKey && !e.shiftKey && e.key === ",") {
      ...
      document.dispatchEvent(
        new CustomEvent("shortcut:settings", { bubbles: true }),
      );
      return;
    }
    ...
    if (metaKey && !e.shiftKey && e.key === "n") {
      e.preventDefault();
      document.dispatchEvent(
        new CustomEvent("shortcut:new-task", { bubbles: true }),
      );
      return;
    }
    ...
    if (metaKey && e.shiftKey && (e.key === "b" || e.key === "B")) {
      e.preventDefault();
      document.dispatchEvent(
        new CustomEvent("shortcut:morning-briefing", { bubbles: true }),
      );
      return;
    }
    ...
    if (metaKey && e.shiftKey && (e.key === "d" || e.key === "D")) {
      e.preventDefault();
      document.dispatchEvent(
        new CustomEvent("shortcut:devtools", { bubbles: true }),
      );
      return;
    }
    ...
    if (metaKey && !e.shiftKey && e.key === "r") {
      ...
      document.dispatchEvent(
        new CustomEvent("shortcut:reload", { bubbles: true }),
      );
      return;
    }
    ...
    if (metaKey && !e.shiftKey) {
      ...
      if (zoneId) {
        e.preventDefault();
        document.dispatchEvent(
          new CustomEvent("shortcut:zone-navigate", {
            detail: { zoneId },
            bubbles: true,
          }),
        );
    ...
    if (e.key === "Escape") {
      ...
      document.dispatchEvent(
        new CustomEvent("shortcut:escape", { bubbles: true }),
      );
      return;
    }
    ...
    if ((e.key === "h" || e.key === "H") && !metaKey) {
      e.preventDefault();
      document.dispatchEvent(
        new CustomEvent("shortcut:camera-home", { bubbles: true }),
      );
      return;
    }
    ...
    if ((e.key === "t" || e.key === "T") && !metaKey) {
      e.preventDefault();
      document.dispatchEvent(
        new CustomEvent("shortcut:theme-picker", { bubbles: true }),
      );
      return;
    }
    ...
    if (e.key === "Tab") {
      ...
      document.dispatchEvent(
        new CustomEvent("shortcut:cycle-zones", {
          detail: { direction },
          bubbles: true,
        }),
      );
    ...
    if (e.key === " ") {
      e.preventDefault();
      document.dispatchEvent(
        new CustomEvent("shortcut:toggle-day-cycle", { bubbles: true }),
      );
      return;
    }
    ...
    if (e.key >= "1" && e.key <= "9" && !metaKey && !e.altKey) {
      e.preventDefault();
      document.dispatchEvent(
        new CustomEvent("shortcut:jump-zone", {
