...
const AGENT_TRAITS = {
  commander: {
    ...
    independence: 95,
    commStyle:
      "Direct and commanding. Prefers brief status-report exchanges. Rarely uses pleasantries.",
  ...
  librarian: {
    ...
    independence: 60,
    commStyle:
      "Verbose and enthusiastic. Loves tangential footnotes and cross-references. Always cites sources.",
  ...
  archivist: {
    ...
    independence: 70,
    commStyle:
      "Measured and precise. Speaks in timestamps. Nostalgic about past events.",
  ...
  instructor: {
    ...
    independence: 50,
    commStyle:
      "Energetic and encouraging. Uses sports metaphors. Always positive, even about failures.",
  ...
  dockmaster: {
    ...
    independence: 85,
    commStyle:
      "Terse and functional. One-word confirmations. Speaks in shipping/port metaphors.",
  ...
  commander: [
    {
      target: "librarian",
      type: "neutral",
      desc: "Respects the knowledge but finds the verbosity slow",
    },
    {
      target: "archivist",
      type: "like",
      desc: "Values the meticulous record-keeping",
    },
    {
      target: "instructor",
      type: "like",
      desc: "Appreciates the training efficiency",
    },
    {
      target: "dockmaster",
      type: "like",
      desc: "Kindred spirits in brevity and action",
    },
  ],
  librarian: [
    {
      target: "commander",
      type: "neutral",
      desc: "Wishes the Commander would read more",
    },
    {
      target: "archivist",
      type: "like",
      desc: "Fellow scholars, always sharing references",
    },
    {
      target: "instructor",
      type: "like",
      desc: "Great collaboration on knowledge transfer",
    },
    {
      target: "dockmaster",
      type: "dislike",
      desc: "Finds the terseness intellectually lacking",
    },
  ],
  archivist: [
    {
      target: "commander",
      type: "like",
      desc: "Admires the decisive leadership",
    },
    { target: "librarian", type: "like", desc: "Shares a love of cataloguing" },
    {
      target: "instructor",
      type: "neutral",
      desc: "Respects the energy, prefers calm",
    },
    {
      target: "dockmaster",
      type: "neutral",
      desc: "Both quiet types, coexist well",
    },
  ],
  instructor: [
    {
      target: "commander",
      type: "like",
      desc: "Loves the challenge of training a leader",
    },
    { target: "librarian", type: "like", desc: "Perfect study partner" },
    {
      target: "archivist",
      type: "neutral",
      desc: "Appreciates history but prefers forward motion",
    },
    {
      target: "dockmaster",
      type: "neutral",
      desc: "Tries to coach, gets one-word answers",
    },
  ],
  dockmaster: [
    { target: "commander", type: "like", desc: "Efficient chain of command" },
    {
      target: "librarian",
      type: "dislike",
      desc: "Too many words, not enough action",
    },
    {
      target: "archivist",
      type: "neutral",
      desc: "Respect for the quiet professionalism",
    },
    {
      target: "instructor",
      type: "neutral",
      desc: "Motivational speeches fall on deaf ears",
    },
  ],
};
...
const AGENT_STATS = {
  ...
  archivist: {
    ...
    skillsUnlocked: 3,
    relationships: 4,
    favoriteZone: "Archive",
    activeSince: "2026-01-18",
  },
  instructor: {
    tasksCompleted: 203,
    xpEarned: 3150,
    skillsUnlocked: 3,
    relationships: 4,
    favoriteZone: "Skills Academy",
    activeSince: "2026-01-20",
  },
  dockmaster: {
    tasksCompleted: 312,
    xpEarned: 4580,
    skillsUnlocked: 4,
    relationships: 4,
    favoriteZone: "Exchange",
    activeSince: "2026-01-22",
  },
};
...
export class AgentProfile {
  ...
  _buildTabs() {
    ...
    for (const key of AGENT_KEYS) {
      ...
      tab.className =
        `ap-tab ap-tab--${key}` +
        (key === this._activeAgent ? " ap-tab--active" : "");
  ...
  _buildStats() {
    ...
    const cards = [
      ...
      },
      {
        ...
        value: `${stats.skillsUnlocked}/5`,
        sub: "",
      },
      {
        icon: "\u{1F91D}",
        label: "Relationships",
        value: stats.relationships.toString(),
        sub: "",
      },
      {
        icon: "\u{1F3E0}",
        label: "Favorite Zone",
        value: stats.favoriteZone,
        sub: "",
      },
      {
        icon: "\u{1F4C5}",
