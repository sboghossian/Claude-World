...
const ZONE_DEFS = [
  { id: 'dispatch_tower',   zone_type: 'dispatch_tower',   name: 'Dispatch Tower',   grid_x: 20, grid_y: 20, grid_w: 4, grid_h: 4, unlocked: 1 },
  { id: 'brain_library',    zone_type: 'brain_library',    name: 'Brain Library',    grid_x: 16, grid_y: 20, grid_w: 3, grid_h: 3, unlocked: 1 },
  { id: 'skills_academy',   zone_type: 'skills_academy',   name: 'Skills Academy',   grid_x: 14, grid_y: 24, grid_w: 3, grid_h: 3, unlocked: 1 },
  { id: 'memory_vault',     zone_type: 'memory_vault',     name: 'Memory Vault',     grid_x: 24, grid_y: 16, grid_w: 3, grid_h: 3, unlocked: 1 },
  { id: 'connector_docks',  zone_type: 'connector_docks',  name: 'Connector Docks',  grid_x: 8,  grid_y: 30, grid_w: 4, grid_h: 3, unlocked: 1 },
  { id: 'chat_rooms',       zone_type: 'chat_rooms',       name: 'Chat Rooms',       grid_x: 14, grid_y: 16, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'treasury',         zone_type: 'treasury',         name: 'Treasury',         grid_x: 28, grid_y: 20, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'minion_tunnels',   zone_type: 'minion_tunnels',   name: 'Minion Tunnels',   grid_x: 24, grid_y: 24, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'legal_tower',      zone_type: 'legal_tower',      name: 'Legal Tower',      grid_x: 16, grid_y: 12, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'sales_district',   zone_type: 'sales_district',   name: 'Sales District',   grid_x: 28, grid_y: 26, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'marketing_plaza',  zone_type: 'marketing_plaza',  name: 'Marketing Plaza',  grid_x: 22, grid_y: 30, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'the_exchange',     zone_type: 'the_exchange',     name: 'The Exchange',     grid_x: 32, grid_y: 18, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'the_market',       zone_type: 'the_market',       name: 'The Market',       grid_x: 32, grid_y: 24, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'the_council',      zone_type: 'the_council',      name: 'The Council',      grid_x: 10, grid_y: 14, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'rd_lab',           zone_type: 'rd_lab',           name: 'R&D Lab',          grid_x: 10, grid_y: 20, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'the_archive',      zone_type: 'the_archive',      name: 'The Archive',      grid_x: 10, grid_y: 26, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'airport',          zone_type: 'airport',          name: 'Airport',          grid_x: 34, grid_y: 10, grid_w: 4, grid_h: 4, unlocked: 0 },
  { id: 'globe_room',       zone_type: 'globe_room',       name: 'Globe Room',       grid_x: 28, grid_y: 10, grid_w: 3, grid_h: 3, unlocked: 0 },
  { id: 'broadcast_tower',  zone_type: 'broadcast_tower',  name: 'Broadcast Tower',  grid_x: 20, grid_y: 8,  grid_w: 3, grid_h: 3, unlocked: 0 },
];
